...
// @generated from protobuf file "project.v1.proto" (package "project.v1", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message project.v1.Project
 */
export interface Project {
    ...
    name: string;
    /**
     * @generated from protobuf field: project.v1.Project.ScreenRatio ratio = 3;
     */
    ...
    screenHeight: number;
    /**
     * @generated from protobuf field: repeated project.v1.Project.RegionOfInterest rois = 6;
     */
...
/**
 * @generated from protobuf message project.v1.Project.RegionOfInterest
 */
export interface Project_RegionOfInterest {
    ...
    height: number;
    /**
     * @generated from protobuf field: project.v1.Project.RegionOfInterest.Anchor anchor = 7;
     */
    anchor: Project_RegionOfInterest_Anchor;
    /**
     * @generated from protobuf field: project.v1.Project.RegionOfInterest.Rect rect = 8;
     */
    rect?: Project_RegionOfInterest_Rect;
}
/**
 * @generated from protobuf message project.v1.Project.RegionOfInterest.Rect
 */
...
/**
 * @generated from protobuf enum project.v1.Project.RegionOfInterest.Anchor
 */
...
/**
 * @generated from protobuf enum project.v1.Project.ScreenRatio
 */
...
class Project$Type extends MessageType<Project> {
    constructor() {
        super("project.v1.Project", [
            { no: 1, name: "uuid", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "ratio", kind: "enum", T: () => ["project.v1.Project.ScreenRatio", Project_ScreenRatio] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string name */ 2:
                    ...
                    break;
                case /* project.v1.Project.ScreenRatio ratio */ 3:
                ...
                case /* int32 screenHeight */ 5:
                    ...
                    break;
                case /* repeated project.v1.Project.RegionOfInterest rois */ 6:
    ...
    internalBinaryWrite(message: Project, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* project.v1.Project.ScreenRatio ratio = 3; */
        if (message.ratio !== 0)
        ...
        /* repeated project.v1.Project.RegionOfInterest rois = 6; */
...
class Project_RegionOfInterest$Type extends MessageType<Project_RegionOfInterest> {
    constructor() {
        super("project.v1.Project.RegionOfInterest", [
            ...
            { no: 7, name: "anchor", kind: "enum", T: () => ["project.v1.Project.RegionOfInterest.Anchor", Project_RegionOfInterest_Anchor] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int32 height */ 6:
                    ...
                    break;
                case /* project.v1.Project.RegionOfInterest.Anchor anchor */ 7:
                    message.anchor = reader.int32();
                    break;
                case /* project.v1.Project.RegionOfInterest.Rect rect */ 8:
    ...
    internalBinaryWrite(message: Project_RegionOfInterest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* project.v1.Project.RegionOfInterest.Anchor anchor = 7; */
        if (message.anchor !== 0)
            writer.tag(7, WireType.Varint).int32(message.anchor);
        /* project.v1.Project.RegionOfInterest.Rect rect = 8; */
        if (message.rect)
...
/**
 * @generated MessageType for protobuf message project.v1.Project.RegionOfInterest
 */
...
class Project_RegionOfInterest_Rect$Type extends MessageType<Project_RegionOfInterest_Rect> {
    constructor() {
        super("project.v1.Project.RegionOfInterest.Rect", [
            { no: 1, name: "uuid", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "x", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 4, name: "y", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 5, name: "width", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
...
/**
 * @generated MessageType for protobuf message project.v1.Project.RegionOfInterest.Rect
 */
