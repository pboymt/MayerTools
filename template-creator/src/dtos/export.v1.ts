...
// @generated from protobuf file "export.v1.proto" (package "export.v1", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message export.v1.Template
 */
export interface Template {
    ...
    height: number;
    /**
     * @generated from protobuf field: export.v1.Template.ScreenRatio screen_ratio = 5;
     */
    ...
    screenHeight: number;
    /**
     * @generated from protobuf field: export.v1.Template.RegionOfInterest roi = 8;
     */
...
/**
 * @generated from protobuf message export.v1.Template.RegionOfInterest
 */
export interface Template_RegionOfInterest {
    ...
    height: number;
    /**
     * @generated from protobuf field: export.v1.Template.RegionOfInterest.Anchor anchor = 5;
     */
    anchor: Template_RegionOfInterest_Anchor;
}
/**
 * @generated from protobuf enum export.v1.Template.RegionOfInterest.Anchor
 */
...
/**
 * @generated from protobuf enum export.v1.Template.ScreenRatio
 */
...
class Template$Type extends MessageType<Template> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int32 height */ 4:
                    ...
                    break;
                case /* export.v1.Template.ScreenRatio screen_ratio */ 5:
                ...
                case /* int32 screenHeight */ 7:
                    ...
                    break;
                case /* export.v1.Template.RegionOfInterest roi */ 8:
    ...
    internalBinaryWrite(message: Template, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* export.v1.Template.ScreenRatio screen_ratio = 5; */
        ...
        /* export.v1.Template.RegionOfInterest roi = 8; */
        if (message.roi)
...
/**
 * @generated MessageType for protobuf message export.v1.Template
 */
...
class Template_RegionOfInterest$Type extends MessageType<Template_RegionOfInterest> {
    constructor() {
        super("export.v1.Template.RegionOfInterest", [
            { no: 1, name: "x", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 2, name: "y", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 3, name: "width", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 4, name: "height", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 5, name: "anchor", kind: "enum", T: () => ["export.v1.Template.RegionOfInterest.Anchor", Template_RegionOfInterest_Anchor] }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int32 height */ 4:
                    message.height = reader.int32();
                    break;
                case /* export.v1.Template.RegionOfInterest.Anchor anchor */ 5:
    ...
    internalBinaryWrite(message: Template_RegionOfInterest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.height !== 0)
            writer.tag(4, WireType.Varint).int32(message.height);
        /* export.v1.Template.RegionOfInterest.Anchor anchor = 5; */
        if (message.anchor !== 0)
...
/**
 * @generated MessageType for protobuf message export.v1.Template.RegionOfInterest
 */
